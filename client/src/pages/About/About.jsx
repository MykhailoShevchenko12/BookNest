      ...
      <div className="about-main">
        <div className="about-container">
          ...
          <div className="about-text">
            <p>
              У кожного є місце, куди хочеться повертатися. Де затишно, де
              звучать історії, що надихають. BookNest — саме таке місце. Ми
              створили наш магазин як гніздечко для всіх, хто шукає більше, ніж
              просто книгу. Ми — спільнота читачів, які вірять у силу слова.
            </p>
            <span>📖 Хто ми?</span>
            <p>
            ...
            <p>
              Наша мета — допомогти тобі знайти саме ту книжку, яка потрібна
              саме зараз. Ми віримо, що у кожного читача є своя книга. І ми тут,
              аби допомогти вам зустрітися.
            </p>
            ...
            <p>
              Бо для нас книжка — як пташина пір’їнка: легка, але здатна
              збудувати цілий світ. Наше гніздечко — це місце, де кожна сторінка
              має сенс, а кожен відвідувач — бажаний гість.
            </p>
