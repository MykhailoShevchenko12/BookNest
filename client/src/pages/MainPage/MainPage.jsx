  ...
  return (
    <div className="main-container">
      <div className="main-page">
        ...
        <div className="bookcategory">
          <p className="bookcategorytext">
            Шлях до себе: книги для саморозвитку
          </p>
        ...
        <div className="main-inspiration-emailnotification">
          <div className="inspiration">
            ...
            <p>
              ...
              підтримувати його активним, що важливо на всіх етапах життя.
              Читання сприяє особистісному зростанню, адже через книги ми
              вчимося аналізувати, розуміти людей та різні життєві ситуації.
              Книги допомагають розвинути емпатію, оскільки, читаючи про героїв
              з різними життєвими труднощами, ми вчимося краще розуміти почуття
              ...
              проблем. Читання книг розширює словниковий запас, роблячи нашу
              мову багатшою та впевненішою, що сприяє покращенню комунікативних
              навичок.
            </p>
            <p>
              Книги — джерело мудрості й натхнення, здатні мотивувати нас до
              нових звершень та надавати нових ідей для самореалізації.
            </p>
            <p>
