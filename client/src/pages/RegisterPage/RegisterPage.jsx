      ...
      <form onSubmit={(e) => e.preventDefault()}>
        <div className="register-main">
          ...
          <div className="register-text">
            <p>
              Шановний користувачу, реєструючись на нашому сайті, ви надаєте
              згоду на обробку ваших персональних даних згідно з чинним
              законодавством.
            </p>
            <ul>
            ...
            <ul>
              Ми зобов’язуємось:
              <li>
                Захищати вашу інформацію за допомогою сучасних технологій
                безпеки.
              </li>
              <li>
