          ...
          <Accordion
            ...
            answer={
              <div className="delivery-and-payment">
                <p>
                  {" "}
                  Ми доставляємо книги по всій Україні за допомогою перевірених
                  служб доставки, таких як Нова Пошта.
                </p>{" "}
                <p>
                  Стандартний термін доставки — <strong>1–3 робочих дні</strong>{" "}
                  після підтвердження замовлення.
                </p>{" "}
                <p>
                  Вартість доставки: <strong>Від 69 грн</strong> — залежить від
                  регіону та ваги замовлення.
                </p>{" "}
                <p>
                  Оплата: <strong>Онлайн-оплата</strong> банківською карткою.{" "}
                  <strong>Накладений платіж</strong> при отриманні (з додатковою
                  комісією згідно тарифів перевізника).
                </p>
              </div>
            }
          />
          <Accordion
            ...
            answer={
              <div className="delivery-and-payment">
                ...
                <p>
                  Повернення можливе{" "}
                  <strong>протягом 14 днів з моменту отримання</strong>, згідно
          ...
          <Accordion
            ...
            answer={
              <div className="delivery-and-payment">
                <p>
                  {" "}
                  Ваші персональні дані — <strong>під надійним захистом</strong>
                  .
                </p>{" "}
                <p>
