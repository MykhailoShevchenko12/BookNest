      ...
      <div className="nav-pannel">
        ...
        <div className="nav-links">
          <ul>
            ...
            >
              ...
              <ul className="catalog-list">
                <div className="list">
                  ...
                  <p>
                    <Link to="/products/bussiness/accounting">Бухгалтерія</Link>
                    ...
                    <Link to="/products/bussiness/management">Менеджмент</Link>
                    <Link to="/products/bussiness/softskills">SoftSkills</Link>
                    <Link to="/products/bussiness/investments">Інвестиції</Link>
            ...
            <Link to={"/about"} className="navigate-links">
              Про нас
            </Link>
            <Link to={"/support"} className="navigate-links">
              Q&A
            </Link>
          </ul>
        </div>
